%global rvm_version_sha1 03dd9e3
...
%changelog
* Thu Jan 03 2013 Tomas E. C. Baudry <tomas.baudry@gmail.com> @kseltar - 1.17.6-0
- Built for Centos 6.3 x86_64
- Minor changes to SPEC file
- SPEC add %files bundle and change rvm_version and sha1
- Build ruby-rvm 11.7.6-0 el6.src.rpm

* Thu Mar 08 2012 Andrew Wyatt <andrew@fuduntu.org> - 1.10.0-2
- Built for Fuduntu
